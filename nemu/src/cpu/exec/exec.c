...
make_group(gp2,
  ...
  /* 0xf6, 0xf7 */
make_group(gp3,
    IDEXW(test_I,test,1), EMPTY, EX(not), EX(neg),  //different
...
opcode_entry opcode_table [512] = {
  ...
  /* 0x68 */	IDEX(I,push), IDEX(I_E2G,imul3)/*may be buggy*/, IDEXW(push_SI,push,1), EMPTY,
  ...
  /* 0xe8 */	IDEX(J, call), IDEX(J,jmp) /*maybe buggy*/, EMPTY, IDEXW(J,jmp,1),
  ...
  /* 0x1c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x20 */	EMPTY, EMPTY, IDEX(mov_E2G,mov_G2C), EMPTY,
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEXW(mov_E2G,movzx,1), IDEXW(mov_E2G,movzx,2)/* maybe buggy */,
  /* 0xb8 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xbc */	EMPTY, EMPTY, IDEXW(mov_E2G,movsx,1), IDEXW(mov_E2G,movsx,2), //0xbf may bebuggy
