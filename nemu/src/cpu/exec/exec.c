...
opcode_entry opcode_table [512] = {
  ...
  /* 0xe4 */	EMPTY, IDEX(in_I2a, in), EMPTY, EMPTY,
  ...
  /* 0xe8 */	EMPTY, EMPTY, EMPTY, IDEXW(J, jmp, 1),
...
void exec_wrapper(bool print_flag) {
  //printf("exec.c:\neip:%#x\teax:%#x\tecx:%#x\tedx:%#x\tebx:%#x\nesp:%#x\tebp:%#x\tesi:%#x\tedi:%#x\n", cpu.eip, cpu.eax, cpu.ecx, cpu.edx, cpu.ebx, cpu.esp, cpu.ebp, cpu.esi, cpu.edi);
  //printf("exec.c: eip:%#x\n", cpu.eip);
